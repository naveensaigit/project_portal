...
class Profile(models.Model):
    ...
    profile_type = models.CharField(max_length=30, choices = YEAR_CHOICES, default = "Student")
    area_of_interest = models.CharField(max_length=100, default="none")
    school = models.CharField(max_length=100, default="none")
    rollno = models.CharField(max_length=10, default="none")
    year = models.CharField(max_length=30, choices = YEAR_CHOICES, default = "none")
    branch = models.CharField(max_length=30, choices = BRANCH_CHOICES, default = "none")
